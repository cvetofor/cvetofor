                    ...
                    <div class="status-page">
                        <div class="status-page">
                            ...
                            <div class="status-page__text">
                                ...
                                <a class="link-button download-account-button" download="download" href="{{ route('order.pdf', ['order' => $order->uuid]) }}" target="_blank">
    ...
    @if($order->paymentStatus->code == \App\Models\PaymentStatus::PAID)
        ...
        window.dataLayer.push({
            "ecommerce": {
                ...
                "purchase": {
                    "actionField": {
                        "id": "{{ $order->num_order }}", // Номер заказа
                        "affiliation": "Цветофор.рф", // Название магазина
                        "revenue": "{{ $order->total_price }}", // Итоговая сумма заказа
                        "tax": 0, // Налог (если применимо)
