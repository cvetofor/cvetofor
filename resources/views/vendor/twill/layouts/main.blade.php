    ...
    <script>
        ...
        @if (config('twill.enabled.media-library'))
            window['{{ config('twill.js_namespace') }}'].STORE.medias.types.push({
                ...
                total: {{ \Gate::allows('is_owner') ? \A17\Twill\Models\Media::count() : \A17\Twill\Models\Media::where('market_id', auth()->user()->getMarketId())->count() }},
        ...
        @if (config('twill.enabled.file-library'))
            window['{{ config('twill.js_namespace') }}'].STORE.medias.types.push({
                ...
                total: {{ \Gate::allows('is_owner') ? \A17\Twill\Models\File::count() : \A17\Twill\Models\File::where('market_id', auth()->user()->getMarketId())->count() }},
