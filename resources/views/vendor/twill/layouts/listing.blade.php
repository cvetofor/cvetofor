...
<div class="listing">
            ...
            <a17-filter v-on:submit="filterListing" v-bind:closed="hasBulkIds"
                ...
                <div slot="additional-actions">
                    <a17-button
                        ...
                        {{ isset($addNewButton) && $addNewButton ? $addNewButton: twillTrans('twill::lang.listing.add-new-button') }}
                    </a17-button>
    ...
    <a17-modal-create
        ...
        <a17-langmanager
            :control-publication="{{ json_encode($controlLanguagesPublication) }}"></a17-langmanager>
