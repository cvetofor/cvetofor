                            ...
                            @if (optional($image)->uuid)
                                <div class="swiper-slide">
                                    <div class="banner__item"
                                         style="background-image: url('{!! ImageService::getRawUrl($image->uuid) !!}')">
                                        <div class="container">
    ...
    <div class="section">
        <div class="container">
            <div class="text-page category_description">
                ...
                <p>В поисках идеального подарка для любимых и близких? Магазин "Цветофор" предлагает широкий ассортимент
                    свежих цветов для любого события. С нашей помощью вы можете легко заказать и купить букеты, не
                    выходя из дома, благодаря удобному онлайн-сервису и оперативной доставке прямо на ваш адрес
                    в {{$city}}.</p><br>
                <h3><strong>Почему стоит выбрать нас?</strong></h3>
                <ul>
                    <li>Широкий ассортимент. В нашем каталоге вы найдете букеты на любой вкус: от классических роз до
                        экзотических орхидей.
                    </li>
                    <li>Доступные цены. Мы предлагаем конкурентоспособные цены и регулярные акции, чтобы вы могли купить
                        цветы недорого.
                    </li>
                    <li>Онлайн-заказ. Заказать доставку цветов в {{$city}} можно прямо на нашем сайте, заполнив простую
                        форму.
                    </li>
                    <li>Быстрая доставка. Наша служба доставки гарантирует, что ваш букет будет доставлен точно в срок,
                        свежим и красивым, прямо на указанный адрес.
                    </li>
                </ul>
                <br>
                ...
                <p>Независимо от того, ищете ли вы букет к празднику, дню рождения, свадьбе или просто хотите сделать
                    приятный сюрприз, "Цветофор" предлагает идеальные варианты для каждого события. Наши опытные
                    флористы соберут для вас букет, который выразит ваши чувства лучше любых слов.</p><br>
                <h3><strong>Сделайте заказ прямо сейчас!</strong></h3>
                <p>Не откладывайте на потом &ndash; сделайте заказ на нашем сайте уже сегодня и порадуйте своих близких
                    в {{$city}} красивым букетом. Магазин "Цветофор" &ndash; ваш надежный помощник в мире цветов!</p>
            </div>
        </div>
    </div>
@endsection
