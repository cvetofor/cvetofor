...
@if($price)
    ...
    <div class="product">
        ...
        <div class="product__bottom">
            ...
            <button class=" add-product-to-cart-button desktop-cart-btn" data-cart-additional-item-add-cat="data-cart-additional-item-add-cat" data-id="{{ $price->id }}">
        ...
        {{-- mobile кнопка --}}
        <button class="mobile-buy-btn button button--green     " style="min-width: 144px;"
                data-cart-additional-item-add-cat="data-cart-additional-item-add-cat" data-id="{{ $price->id }}">
            Заказать
        </button>
    </div>
@endif
