    ...
    @if($with2faSettings ?? false)
        ...
        @unless($item->google_2fa_enabled ?? false)
            <x-twill::formConnectedFields
                ...
                :field-values="true"
            >
                <div style="display: block; margin-left: auto; margin-right: auto; max-height: 300px;">
                    <img src="{!! $qrCode !!}" alt="">
                </div>
                <div class="f--regular f--note"
                     style="margin: 20px 0;">{!! twillTrans('twill::lang.user-management.2fa-description', ['link' => 'https://yandex.ru/support/id/authorization/twofa.html']) !!}</div>
                <x-twill::input
                    name="verify-code"
...
@section('fieldsets')
    ...
    <a17-fieldset title="Присылать уведомления о заказе">
        <div class="wrapper">
            <div class="col--double col--double-wrap" style="margin-top:10px;">
                <x-twill::checkbox
                    name="send_notify_phone"
                    label="На телефон"
                    disabled="disabled"
                />
            </div>
