...
')
     ...
     */ 
         ...
         * @return \avadim\FastExcelLaravel\ExcelWriter 
         * @static 
         */ 
        public static function create($sheets = null, $options = [])
        {
                        return \avadim\FastExcelLaravel\Excel::create($sheets, $options);
        }
                    /**
         ...
         * @param string $file
         * @param array|null $options
         * @return \avadim\FastExcelLaravel\ExcelReader 
         * @static 
         */ 
        public static function open($file, $options = [])
        {
                        return \avadim\FastExcelLaravel\Excel::open($file, $options);
        }
...
namespace  { 
            ...
            class Excel extends \avadim\FastExcelLaravel\Facades\Excel {}
